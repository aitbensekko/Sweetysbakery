...
"[project]/Desktop/Projects/TEST3/data/additionalBlogPosts.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const additionalBlogPosts = [
    ...
    {
        id: 126,
        slug: 'classic-vanilla-bean-cupcakes',
        title: "Classic Vanilla Bean Cupcakes | Sweety's Bakery",
        excerpt: "Moist, fluffy, and speckled with real vanilla bean. These cupcakes are topped with a whipped vanilla buttercream that melts in your mouth.",
        imageUrl: 'https://sweetysbakery.com/images/vanilla-cupcakes.jpg',
        category: 'Cupcakes',
        author: 'Sweety\'s Bakery',
        ...
        type: 'recipe',
        content: `
            <h2>Classic Vanilla Bean Cupcakes</h2>
            <p>Simple perfection. These cupcakes use cake flour for a tender crumb and sour cream for moisture. The star is the vanilla bean paste.</p>
            
            <h3>Ingredients</h3>
            <ul>
                <li>1 and 2/3 cups cake flour</li>
                <li>1/2 tsp baking powder & 1/4 tsp baking soda</li>
                <li>1/2 cup unsalted butter, softened</li>
                <li>1 cup granulated sugar</li>
                <li>2 large egg whites (for fluffiness)</li>
            ...
            <h3>Instructions</h3>
            <ol>
                <li><strong>Whisk Dry:</strong> Combine flour, baking powder, baking soda, and salt.</li>
                <li><strong>Cream:</strong> Beat butter and sugar until pale and fluffy (3-4 mins). Add egg whites and vanilla.</li>
                <li><strong>Combine:</strong> Add dry ingredients alternating with milk/sour cream mixture. Do not overmix.</li>
                <li><strong>Bake:</strong> Fill liners 2/3 full. Bake at 350°F (177°C) for 18-20 minutes.</li>
            </ol>
        `
    },
    {
        id: 127,
        slug: 'grandmas-deep-dish-apple-pie',
        title: "Grandma's Deep Dish Apple Pie | Sweety's Bakery",
        excerpt: "A mountain of spiced apples encased in a flaky, all-butter double crust. The ultimate comfort food dessert.",
        imageUrl: 'https://sweetysbakery.com/images/apple-pie.jpg',
        category: 'Pies',
        author: 'Sweety\'s Bakery',
        ...
        type: 'recipe',
        content: `
            <h2>Grandma's Deep Dish Apple Pie</h2>
            <p>The secret to this pie is precooking the filling slightly to prevent a gap between the crust and the fruit.</p>

            <h3>Ingredients</h3>
            <ul>
                <li>2 discs of pie dough (homemade is best!)</li>
                <li>3 lbs Granny Smith apples, peeled and sliced</li>
                <li>3 lbs Honeycrisp apples, peeled and sliced</li>
                <li>1/2 cup brown sugar & 1/2 cup white sugar</li>
                <li>1 tbsp lemon juice</li>
                <li>1 tsp cinnamon, 1/4 tsp nutmeg</li>
                <li>3 tbsp cornstarch</li>
            </ul>

            <h3>Instructions</h3>
            <ol>
                <li><strong>Macerate:</strong> Toss apples with sugars, lemon, and spices. Let sit for 30 mins to draw out juice.</li>
                <li><strong>Thicken:</strong> Drain the juice into a saucepan. Boil down until syrupy. Toss back with apples and cornstarch.</li>
                <li><strong>Assemble:</strong> Roll out bottom crust. Pile apples high. Top with lattice crust.</li>
                <li><strong>Bake:</strong> 400°F for 20 mins, then 375°F for 40-50 mins until bubbling.</li>
            </ol>
        `
    },
    {
        id: 128,
        slug: 'zesty-lemon-bars',
        title: "Zesty Lemon Bars with Shortbread Crust | Sweety's Bakery",
        excerpt: "A thick, buttery shortbread crust topped with a gooey, tart lemon curd filling. Dusted with powdered sugar for the perfect finish.",
        imageUrl: 'https://sweetysbakery.com/images/lemon-bars.jpg',
        category: 'Bars',
        author: 'Sweety\'s Bakery',
        ...
        type: 'recipe',
        content: `
            <h2>Zesty Lemon Bars</h2>
            <p>Bright, tangy, and sweet. The ratio of filling to crust here is generous.</p>
            ...
            <h3>Instructions</h3>
            <ol>
                <li><strong>Crust:</strong> Mix ingredients. Press into 9x13 pan. Bake at 350°F for 20 mins until golden.</li>
                <li><strong>Filling:</strong> Whisk sugar, flour, eggs, and lemon juice until smooth. Pour over hot crust.</li>
                <li><strong>Bake:</strong> Bake for another 20-25 minutes until set but still wiggly in center. Cool completely before cutting.</li>
            </ol>
        `
    },
    {
        id: 129,
        slug: 'best-ever-banana-bread',
        title: "Best-Ever Banana Bread (Super Moist) | Sweety's Bakery",
        excerpt: "Use your brownest bananas for this recipe! Loaded with flavor, moist for days, and delicious with or without walnuts.",
        imageUrl: 'https://sweetysbakery.com/images/banana-bread.jpg',
        category: 'Bread',
        author: 'Sweety\'s Bakery',
        ...
        content: `
            ...
            <p>The trick is using melted butter for density and yogurt for moisture.</p>
            ...
            <h3>Instructions</h3>
            <ol>
                <li><strong>Mash:</strong> Mash bananas well.</li>
                <li><strong>Mix Wet:</strong> Whisk melted butter and sugar. Add eggs, yogurt, vanilla, and bananas.</li>
                <li><strong>Combine:</strong> Fold in dry ingredients gently.</li>
                <li><strong>Bake:</strong> Pour into loaf pan. Bake at 350°F for 60-65 minutes. Tent with foil if browning too fast.</li>
            </ol>
        `
    },
    {
        ...
        title: "Ultimate Fudgy Brownies (Better Box Mix) | Sweety's Bakery",
        excerpt: "Crackly tops, chewy edges, and a dense, fudgy center. These brownies are made with both melted chocolate and cocoa powder.",
        imageUrl: 'https://sweetysbakery.com/images/brownies.jpg',
        category: 'Bars',
        author: 'Sweety\'s Bakery',
        date: 'January 1, 2026',
        readTime: '20 min',
        type: 'recipe',
        content: `
            <h2>Ultimate Fudgy Brownies</h2>
            <p>Forget the mixer. These are best made by hand to prevent incorporating air (which makes them cakey).</p>

            <h3>Ingredients</h3>
            <ul>
                <li>1/2 cup butter</li>
                <li>8 oz semi-sweet chocolate, chopped</li>
                <li>3/4 cup granulated sugar & 1/4 cup brown sugar</li>
                <li>3 large eggs</li>
                <li>1/2 cup flour</li>
            ...
            <h3>Instructions</h3>
            <ol>
                <li><strong>Melt:</strong> Melt butter and chocolate together. Whisk in sugars while hot.</li>
                <li><strong>Eggs:</strong> Whisk in eggs one at a time.</li>
                <li><strong>Dry:</strong> Fold in flour and cocoa powder until just combined.</li>
                <li><strong>Bake:</strong> 8x8 pan. 350°F for 25-30 minutes. Do not overbake!</li>
            </ol>
        `
    },
    {
        ...
        title: "Bakery Style Blueberry Muffins | Sweety's Bakery",
        excerpt: "Tall, domed muffin tops loaded with juicy blueberries and finished with a crunchy sugar streusel.",
        imageUrl: 'https://sweetysbakery.com/images/blueberry-muffins.jpg',
        category: 'Breakfast',
        author: 'Sweety\'s Bakery',
        date: 'January 2, 2026',
        readTime: '15 min',
        type: 'recipe',
        content: `
            <h2>Bakery Style Blueberry Muffins</h2>
            <p>To get that high dome, we start baking at a high temperature to spring the batter, then lower it.</p>
            ...
            <ul>
                ...
                <li>2 eggs</li>
                <li>1 cup buttermilk</li>
                <li>1 and 1/2 cups fresh blueberries</li>
            </ul>

            <h3>Instructions</h3>
            <ol>
                <li><strong>Mix:</strong> Combine dry. Whisk wet. Fold together. Gently add berries. Batter will be thick.</li>
                <li><strong>Fill:</strong> Fill muffin tins all the way to the top.</li>
                <li><strong>Bake:</strong> 425°F for 5 minutes, then reduce to 375°F for 15-18 minutes.</li>
            </ol>
        `
    },
    {
        ...
        title: "Spiced Carrot Cake with Cream Cheese Frosting | Sweety's Bakery",
        excerpt: "Incredibly moist and perfectly spiced. This carrot cake is dense but soft, and the frosting is tangy and sweet.",
        imageUrl: 'https://sweetysbakery.com/images/carrot-cake.jpg',
        category: 'Cakes',
        author: 'Sweety\'s Bakery',
        date: 'January 3, 2026',
        readTime: '30 min',
        type: 'recipe',
        content: `
            <h2>Spiced Carrot Cake</h2>
            <p>We use oil instead of butter to keep this cake moist for days. Freshly grated carrots are a must—pre-shredded are too dry.</p>

            <h3>Ingredients</h3>
            <ul>
                <li>2 cups flour</li>
                <li>2 tsp baking soda</li>
                <li>2 tsp cinnamon, 1/2 tsp ginger, 1/4 tsp nutmeg</li>
                <li>1 and 1/4 cups oil (canola or vegetable)</li>
                <li>1 cup sugar & 1 cup brown sugar</li>
                <li>4 eggs</li>
            ...
            <h3>Instructions</h3>
            <ol>
                <li><strong>Whisk:</strong> Whisk oil and sugars. Add eggs one by one.</li>
                <li><strong>Combine:</strong> Add dry ingredients. Fold in carrots and nuts.</li>
                <li><strong>Bake:</strong> Two 9-inch pans. 350°F for 35-45 minutes.</li>
            </ol>
        `
    },
    {
        id: 133,
        slug: 'molten-chocolate-lava-cakes',
        title: "Molten Chocolate Lava Cakes | Sweety's Bakery",
        excerpt: "Restaurant-quality dessert made at home in 20 minutes. A rich chocolate cake shell with a flowing molten chocolate center.",
        imageUrl: 'https://sweetysbakery.com/images/lava-cakes.jpg',
        category: 'Dessert',
        author: 'Sweety\'s Bakery',
        date: 'January 4, 2026',
        readTime: '10 min',
        type: 'recipe',
        content: `
            <h2>Molten Chocolate Lava Cakes</h2>
            <p>Surprisingly easy. The trick is baking them just enough to set the outside while leaving the middle raw (but safe to eat).</p>
            ...
            <ul>
                ...
                <li>2 whole eggs + 2 egg yolks</li>
                <li>6 tbsp flour</li>
            </ul>

            <h3>Instructions</h3>
            <ol>
                <li><strong>Melt:</strong> Melt butter and chocolate. Whisk in sugar.</li>
                <li><strong>Eggs:</strong> Whisk in eggs and yolks. Stir in flour.</li>
                <li><strong>Prep:</strong> Grease ramekins well and dust with cocoa powder.</li>
                <li><strong>Bake:</strong> 425°F for 13-14 minutes. The sides should be firm but center soft. Invert onto plate immediately.</li>
            </ol>
        `
    },
    {
        ...
        title: "Soft & Chewy Homemade Pretzels | Sweety's Bakery",
        excerpt: "Better than the mall. These pretzels are dipped in a baking soda bath to get that classic dark, chewy crust.",
        imageUrl: 'https://sweetysbakery.com/images/pretzels.jpg',
        category: 'Snacks',
        author: 'Sweety\'s Bakery',
        date: 'January 5, 2026',
        readTime: '45 min',
        type: 'recipe',
        content: `
            <h2>Soft & Chewy Homemade Pretzels</h2>
            <p>The baking soda bath is the key step you cannot skip. It alkalizes the dough surface for browning.</p>
            ...
            <ul>
                ...
                <li>1 tbsp sugar</li>
                <li>4 and 1/2 cups flour</li>
                <li>2 tbsp butter, melted</li>
                <li><strong>Bath:</strong> 10 cups water + 2/3 cup baking soda</li>
            </ul>

            <h3>Instructions</h3>
            <ol>
                <li><strong>Dough:</strong> Mix water, yeast, sugar. Add flour and butter. Knead 5 mins. Rise 1 hour.</li>
                <li><strong>Shape:</strong> Divide into 8. Roll into long ropes and twist into pretzel shape.</li>
                <li><strong>Bath:</strong> Boil water and soda. Dip each pretzel for 30 seconds.</li>
                <li><strong>Bake:</strong> Brush with egg wash, sprinkle salt. 450°F for 12-15 minutes.</li>
            </ol>
        `
    },
    {
        ...
        title: "Classic New York Cheesecake | Sweety's Bakery",
        excerpt: "Dense, rich, and creamy with a graham cracker crust. This is the tall, impressive cheesecake of your dreams.",
        imageUrl: 'https://sweetysbakery.com/images/ny-cheesecake.jpg',
        category: 'Cheesecake',
        author: 'Sweety\'s Bakery',
        date: 'January 6, 2026',
        readTime: '40 min',
        type: 'recipe',
        content: `
            <h2>Classic New York Cheesecake</h2>
            <p>Use full-fat ingredients for the best texture. And don't skip the water bath!</p>

            <h3>Ingredients</h3>
            <ul>
                <li>2 cups graham cracker crumbs + 1/2 cup butter (Crust)</li>
                <li>32 oz (4 blocks) cream cheese, room temp</li>
            ...
            <h3>Instructions</h3>
            <ol>
                <li><strong>Crust:</strong> Press crumbs/butter into 9-inch springform. Bake 10 mins at 350°F.</li>
                <li><strong>Filling:</strong> Beat cream cheese and sugar until smooth. Add milk, then eggs one at a time. Stir in sour cream, vanilla, flour.</li>
                <li><strong>Bake:</strong> Pour over crust. Place pan in water bath. Bake at 350°F for 1 hour. Turn oven off, let sit inside for 1 hour. Chill overnight.</li>
            </ol>
        `
    }
];
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$TEST3$2f$data$2f$additionalBlogPosts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Projects/TEST3/data/additionalBlogPosts.ts [app-ssr] (ecmascript)");
;
const blogPosts = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Projects$2f$TEST3$2f$data$2f$additionalBlogPosts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["additionalBlogPosts"],
    {
        id: 1,
...
//# sourceMappingURL=Desktop_Projects_TEST3_data_724880eb._.js.map