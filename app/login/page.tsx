        ...
        <div className="fixed inset-0 bg-[#FDFBF7] flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 z-50">
            ...
            <div className="w-full max-w-md bg-white rounded-2xl sm:rounded-[2rem] shadow-xl border border-stone-100 overflow-hidden relative">
                ...
                <div className="p-6 sm:p-8 md:p-10">
                    <h1 className="font-serif text-2xl sm:text-3xl font-bold text-stone-900 mb-2">Welcome Back</h1>
                    <p className="text-sm sm:text-base text-stone-500 mb-6 sm:mb-8">Enter your email to access your dashboard.</p>
                    ...
                    <form onSubmit={handleLogin} className="space-y-4 sm:space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3 sm:py-4 bg-stone-900 hover:bg-brand-pink text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                        >
                ...
                <div className="bg-stone-50 p-4 sm:p-6 text-center text-xs sm:text-sm text-stone-400 border-t border-stone-100">
                    Don't have an account? <Link href="/" className="text-brand-pink font-bold hover:underline">Explore Our Tools</Link>
                </div>
            </div>
        </div>
    );
