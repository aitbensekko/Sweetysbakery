...
const availableTools = [
    { slug: 'cake-pricing', title: 'Cake Pricing Calculator', icon: '🎂' },
    ...
    { slug: 'dough-hydration', title: 'Dough Hydration Calculator', icon: '💧' },
    { slug: 'baking-pan-converter', title: 'Baking Pan Converter', icon: '🍰' },
    { slug: 'oven-temp-converter', title: 'Oven Temperature Converter', icon: '🌡️' },
    ...
    { slug: 'cost-per-recipe', title: 'Cost Per Recipe', icon: '💰' },
    { slug: 'investment-calculator', title: 'Investment Calculator', icon: '📈' },
    { slug: 'mortgage-affordability', title: 'Mortgage Affordability Calculator', icon: '🏠' },
